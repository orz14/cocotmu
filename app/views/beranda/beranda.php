        ...
        if (isset($_POST["login"])) {
          ...
          if (mysqli_num_rows($result) === 1) {
            ...
            if (password_verify($password, $row["password"])) {
              ...
              // recent login
              $nama = $row["nama"];
              mysqli_query($koneksi, "INSERT INTO login_tb VALUES(null, '$nama', '$date')");
              echo "
                <script>
                    ...
                    <div class="dropdown dropdown-orz">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end">
                        <?php if ($postingan["suspend"] === "false") : ?>
                          <li>
                            <a class="dropdown-item clickk" href="<?= BASEURL; ?>/post/edit/<?= $postingan["id"]; ?>"><span class="jejer"><i class="bx bx-edit"></i>&nbsp;Edit Post</span></a>
                          </li>
                        <?php endif; ?>
                        <li>
